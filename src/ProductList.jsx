...
function ProductList({ onHomeClick }) {
    ...
    // Calculate total item count dynamically for the navbar bubble
    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Lavender Repel", image: "https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", description: "Aromatic leaves keep moths and flies at bay.", cost: "$20" }
            ]
        }
    ];
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        <img src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="Eco Logo" style={{width:'40px', marginRight:'10px'}} />
